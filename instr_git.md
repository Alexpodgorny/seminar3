...
## Созданьие новых веток
    git branch имя ветки - позволяет создать новую ветку и переключаться между ними.

## Удаление веток
    git branch -d имя ветки - позволяет удалить ветку.

## Разрешение конфликта
- для разрешения конфликта между вливаемыми ветками -необходимо выбрать один из вариантов конфликта.
  
  ## Удаленные репозитории
  
  Удаленные репозитории нужны для публикации вашего кода всему миру (или некоторым людям) и позволить им читать или писать его.
